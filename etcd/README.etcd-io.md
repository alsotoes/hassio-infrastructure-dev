...
Same-ish [README.md](https://github.com/etcd-io/etcd/blob/main/README.md) minor changes to links and images to point the oficial etcd-io repo.
...
etcd is used [in production by many companies](https://github.com/etcd-io/etcd/blob/main/ADOPTERS.md), and the development team stands behind it in critical deployment scenarios, where etcd is frequently teamed with applications such as [Kubernetes][k8s], [locksmith][], [vulcand][], [Doorman][], and many others. Reliability is further ensured by rigorous [**robustness testing**](https://github.com/etcd-io/etcd/tree/main/tests/robustness).

See [etcdctl][etcdctl] for a simple command line client.

![etcd reliability is important](https://raw.githubusercontent.com/etcd-io/etcd/main/logos/etcd-xkcd-2347.png)
...
[Maintainers](https://github.com/etcd-io/etcd/blob/main/OWNERS) strive to shape an inclusive open source project culture where users are heard and contributors feel respected and empowered. Maintainers aim to build productive relationships across different companies and disciplines. Read more about [Maintainers role and responsibilities](https://github.com/etcd-io/etcd/blob/main/Documentation/contributor-guide/community-membership.md#maintainers).
...
If etcd is installed using the [pre-built release binaries](https://github.com/etcd-io/etcd/releases), run it from the installation location as below:
...
Our [Procfile script](https://github.com/etcd-io/etcd/blob/main/Procfile) will set up a local example cluster. Start it with:
...
Follow the comments in [Procfile script](https://github.com/etcd-io/etcd/blob/main/Procfile) to add a learner node to the cluster.
...
See [CONTRIBUTING](https://github.com/etcd-io/etcd/blob/main/CONTRIBUTING.md) for details on setting up your development environment, submitting patches and the contribution workflow.

Please refer to [community-membership.md](https://github.com/etcd-io/etcd/blob/main/Documentation/contributor-guide/community-membership.md#member) for information on becoming an etcd project member.  We welcome and look forward to your contributions to the project!

Please also refer to [roadmap](https://github.com/etcd-io/etcd/blob/main/Documentation/contributor-guide/roadmap.md) to get more details on the priorities for the next few major or minor releases.
...
See [security disclosure and release process](https://github.com/etcd-io/etcd/blob/main/security/README.md) for details on how to report a security vulnerability and how the etcd team manages it.
...
etcd is under the Apache 2.0 license. See the [LICENSE](https://github.com/etcd-io/etcd/blob/main/LICENSE) file for details.
